...
Product* ProductBookParser::makeProduct()
{
    ...
    Product* productBook= new Book(id,prodName_,price_,qty_,isbn_,author_);
    return productBook;
}
...
{
    string id=categoryID();
    Product* productClothing= new Clothing(id,prodName_,price_,qty_,size_,brand_);
...
{
    string id=categoryID();
    Product* productMovie= new Movie(id,prodName_,price_,qty_,genre_,rating_);
    return productMovie;
}
